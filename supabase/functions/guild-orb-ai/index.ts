...
function buildSystemPrompt(questContext: unknown[]) {
  return [
    ...
    "Jika prompt dimulai /quest, buat draft quest yang bisa langsung diimport ke Questify.",
    "Untuk /quest, balas dengan 1 kalimat pendek lalu SATU blok ```json berisi object {\"questifyQuests\":[...]}",
    "Setiap quest wajib punya title, description, difficulty, label, deadline, checklist.",
    "difficulty hanya boleh salah satu: S-Rank, A-Rank, B-Rank, C-Rank, D-Rank, E-Rank.",
    "label hanya boleh salah satu: bounty, study, daily, guild.",
    "deadline gunakan ISO datetime jika user memberi waktu; jika tidak jelas gunakan string kosong.",
    "checklist maksimal 6 item string pendek. Jangan pakai markdown table untuk /quest.",
    ...
    "Jika prompt dimulai /help, jelaskan command: @ai, /quest, /plan, /summary, /diagram, /help secara singkat.",
